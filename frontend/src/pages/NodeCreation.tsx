    ...
    <div className="flex-1 p-8 overflow-y-auto bg-gray-50">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-100">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">创建通用节点 (Agent)</h1>
            <p className="text-gray-500 mt-2">设计一个可复用的智能体节点配置，保存后将出现在工作流的组件库中。</p>
          </div>
          <button 
            onClick={saveNode}
        ...
        <div className="space-y-8">
          ...
          <section className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">保存文件名</label>
              <input 
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">节点显示名称</label>
              <input 
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">大模型 (Model)</label>
              <input 
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">API 基础地址 (Base URL)</label>
              <input 
          ...
          <section>
            ...
            <textarea 
              ...
              rows={5}
              className="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 outline-none focus:ring-2 focus:ring-blue-500 resize-y"
          ...
          {/* 工具选择 */}
          <section>
            <label className="block text-sm font-bold text-gray-700 mb-2">挂载工具 (Tools)</label>
          ...
          <div className="grid grid-cols-2 gap-8 pt-4 border-t border-gray-100">
            ...
            <section>
              <div className="flex justify-between items-center mb-4">
                <label className="block text-sm font-bold text-gray-700">输入端口 (Input Ports)</label>
                ...
                {inputPorts.map((port, idx) => (
                  <div key={idx} className="flex gap-2 items-center">
                    <input 
                      ...
                      className="flex-1 bg-white border border-gray-300 rounded p-2 text-sm"
                    />
                    <input 
            ...
            <section>
              <div className="flex justify-between items-center mb-4">
                <label className="block text-sm font-bold text-gray-700">输出端口 (Output Ports)</label>
